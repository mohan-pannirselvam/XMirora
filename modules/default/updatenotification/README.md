...
The `updatenotification` module is one of the default modules of the XMirora.
This will display a message whenever a new version of the XMirora application is available.
