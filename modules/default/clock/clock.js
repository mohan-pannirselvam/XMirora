...
Module.register("clock",{
	...
	getDom: function() {
		...
		// See issue: https://gitHub.com/mohan-pannirselvam/XMirora/issues/181
		var timeString;
		var now = moment();
		 ...
		 */
		 ...
		 if (this.config.displayType !== "digital") {
			...
			if (this.config.analogFace != "" && this.config.analogFace != "simple" && this.config.analogFace != "none") {
				...
				// The following line solves issue: https://gitHub.com/mohan-pannirselvam/XMirora/issues/611
