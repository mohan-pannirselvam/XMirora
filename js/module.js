...
var Module = Class.extend({
	...
	// Set the minimum XMirora module version for this module.
...
Module.register = function (name, moduleDefinition) {
	...
	if (moduleDefinition.requiresVersion) {
		Log.log("Check XMirora version for module '" + name + "' - Minimum version:  " + moduleDefinition.requiresVersion + " - Current version: " + version);
