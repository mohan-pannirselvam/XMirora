...
console.log("Starting XMirora: v" + global.version);
...
// https://gitHub.com/mohan-pannirselvam/XMirora/pull/673
...
process.on("uncaughtException", function (err) {
	...
	console.error(err);
	console.log("XMirora will not quit, but it might be a good idea to check why this happened. Maybe no internet connection?");
	console.log("If you think this really is an issue, please open an issue on GitHub: https://gitHub.com/mohan-pannirselvam/XMirora/issues");
});
...
var App = function() {
	...
	var loadConfig = function(callback) {
		...
		// https://forum.XMirora.builders/topic/1456/test-suite-for-XMirora/8
	...
	var loadModule = function(module, callback) {
		...
		if (loadModule) {
			...
			if (m.requiresVersion) {
				console.log("Check XMirora version for node helper '" + moduleName + "' - Minimum version:  " + m.requiresVersion + " - Current version: " + global.version);
